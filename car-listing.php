...
<title>E-REMES | Band Listing</title>
<!--Bootstrap -->
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">IDR<?php echo htmlentities($result->PricePerDay);?> Per Day</p>
            <ul>
              <li><i class=" " aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Anggota</li>
              <li><i class=" " aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> </li>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Find Your  Band </h5>
          </div>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control" name="fueltype">
                  <option>Select Genre Music</option>
<option value="Petrol">Pop</option>
<option value="Diesel">Accoustic</option>
<option value="CNG">Jazz</option>
                </select>
              </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class=" " aria-hidden="true"></i> Recently Listed Band</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">IDR<?php echo htmlentities($result->PricePerDay);?> Per Day</p>
                </div>
              </li>
              <?php }} ?>
