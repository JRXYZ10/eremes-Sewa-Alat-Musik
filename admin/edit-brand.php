...
<head>
	...
	<title>E-REMES | Admin Update</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Update Rental Type</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Update Rental Type</div>
...
?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Rental Type</label>
												<div class="col-sm-8">
